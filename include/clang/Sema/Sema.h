...
public:
  ...
  StmtResult ActOnLoopUnrollDeclarator();
  unsigned GetLoopUnrollTupleSize(ExprResult *TupleExprResult);
  StmtResult ActOnLoopUnrollStmt(SourceLocation, SourceLocation, StmtResult,//VarDecl*,
                                 ExprResult, SourceLocation, StmtResult, SourceLocation, SourceLocation);
