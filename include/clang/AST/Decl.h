...
protected:
  ...
  class NonParmVarDeclBitfields {
    ...
    /// \brief Whether this variable is the loop-unroll-declaration in a
    /// the loop-unroll statement
    unsigned CXXLoopUnrollDecl: 1;
...
public:
  ...
  bool isCXXLoopUnrollDecalaration() const {
      return isa<ParmVarDecl>(this) ? false : NonParmVarDeclBits.CXXLoopUnrollDecl;
  }
  void setCXXLoopUnrollDeclaration(bool LUD) {
      assert(!isa<ParmVarDecl>(this));
      NonParmVarDeclBits.CXXLoopUnrollDecl = LUD;
  }
