...
private:
  ...
  struct LoopUnrollInit {
      VarDecl* ControlVarDecl;
      SourceLocation ColonLocation;
      ExprResult TupleExpr;

      bool ParsedLoopUnrollDecl() {
          return !ColonLocation.isInvalid();
      }
  };
  ...
  StmtResult ParseLoopUnrollStatement(SourceLocation *TrailingElseLoc);
  DeclGroupPtrTy ParseLoopUnrollDeclaration(LoopUnrollInit *LUInit, SourceLocation &DeclEnd,
